type DOCUMENT_MESSAGE_NAME_GType record {|
...
type DATE_TIME_PERIOD_GType record {|
...
type PAYMENT_INSTRUCTION_DETAILS_GType record {|
...
type ITEM_DESCRIPTION_GType record {|
...
type TEXT_REFERENCE_GType record {|
   string Free_text__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
|};

type TEXT_LITERAL_GType record {|
   string Free_text?;
   string Free_text_1?;
   string Free_text_2?;
   string Free_text_3?;
...
type Segment_Group_1_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type PARTY_IDENTIFICATION_DETAILS_GType record {|
   string Party_id_identification?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
|};

type NAME_AND_ADDRESS_GType record {|
...
type LOCATION_IDENTIFICATION_GType record {|
...
type RELATED_LOCATION_ONE_IDENTIFICATION_GType record {|
...
type RELATED_LOCATION_TWO_IDENTIFICATION_GType record {|
...
type ACCOUNT_IDENTIFICATION_GType record {|
...
type INSTITUTION_IDENTIFICATION_GType record {|
...
type Segment_Group_3_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type DOCUMENT_MESSAGE_NAME2_GType record {|
   string Document_message_name__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
   string Document_message_name?;
...
type DOCUMENT_MESSAGE_DETAILS_GType record {|
   string Document_message_number?;
...
type Segment_Group_4_GType record {|
   Document_message_details_Type Document_message_details;
   Date_time_period_Type[] Date_time_period?;
|};

type DEPARTMENT_OR_EMPLOYEE_DETAILS_GType record {|
...
type COMMUNICATION_CONTACT_GType record {|
...
type DUTY_TAX_FEE_TYPE_GType record {|
...
type DUTY_TAX_FEE_ACCOUNT_DETAIL_GType record {|
   string Duty_tax_fee_account_identification?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
|};

type DUTY_TAX_FEE_DETAIL_GType record {|
...
type MONETARY_AMOUNT_GType record {|
...
type CURRENCY_DETAILS_1_GType record {|
   string Currency_details_qualifier?;
   string Currency__coded?;
   string Currency_qualifier?;
   float Currency_rate_base?;
...
type Segment_Group_7_GType record {|
   Currencies_Type Currencies;
   Date_time_period_Type[] Date_time_period?;
|};

type PAYMENT_TERMS_GType record {|
...
type TERMS_TIME_INFORMATION_GType record {|
...
type PERCENTAGE_DETAILS_GType record {|
...
type Segment_Group_8_GType record {|
...
type EXCESS_TRANSPORTATION_INFORMATION_GType record {|
...
type TRANSPORT_IDENTIFICATION_GType record {|
...
type Segment_Group_10_GType record {|
   Place_location_identification_Type Place_location_identification;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_9_GType record {|
   Details_of_transport_Type Details_of_transport;
   Segment_Group_10_GType[] Segment_Group_10?;
|};

type TERMS_OF_DELIVERY_GType record {|
...
type PACKAGE_TYPE_IDENTIFICATION_GType record {|
   string Item_description_type__coded?;
   string Type_of_packages?;
...
type RETURNABLE_PACKAGE_DETAILS_GType record {|
...
type MARKS___LABELS_GType record {|
...
type IDENTITY_NUMBER_RANGE_GType record {|
   string Identity_number?;
   string Identity_number_1?;
|};

type IDENTITY_NUMBER_RANGE_1_GType record {|
   string Identity_number?;
   string Identity_number_1?;
|};

type IDENTITY_NUMBER_RANGE_2_GType record {|
   string Identity_number?;
   string Identity_number_1?;
|};

type IDENTITY_NUMBER_RANGE_3_GType record {|
   string Identity_number?;
   string Identity_number_1?;
|};

type IDENTITY_NUMBER_RANGE_4_GType record {|
   string Identity_number?;
   string Identity_number_1?;
|};
...
type Segment_Group_13_GType record {|
...
type Segment_Group_15_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type QUANTITY_DETAILS_GType record {|
...
type Segment_Group_16_GType record {|
   Quantity_Type Quantity;
   Range_details_Type Range_details?;
|};

type Segment_Group_17_GType record {|
   Percentage_details_Type Percentage_details;
   Range_details_Type Range_details?;
|};

type Segment_Group_18_GType record {|
   Monetary_amount_Type Monetary_amount;
   Range_details_Type Range_details?;
|};

type RATE_DETAILS_GType record {|
...
type Segment_Group_19_GType record {|
   Rate_details_Type Rate_details;
   Range_details_Type Range_details?;
|};

type Segment_Group_20_GType record {|
   Duty_tax_fee_details_Type Duty_tax_fee_details;
   Monetary_amount_Type Monetary_amount?;
|};

type Segment_Group_14_GType record {|
...
type REQUIREMENT_CONDITION_IDENTIFICATION_GType record {|
...
type Segment_Group_21_GType record {|
...
type ITEM_NUMBER_IDENTIFICATION_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type ITEM_NUMBER_IDENTIFICATION2_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type ITEM_NUMBER_IDENTIFICATION_1_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type ITEM_NUMBER_IDENTIFICATION_2_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type ITEM_NUMBER_IDENTIFICATION_3_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type ITEM_NUMBER_IDENTIFICATION_4_GType record {|
   string Item_number?;
   string Item_number_type__coded?;
   string Code_list_qualifier?;
   string Code_list_responsible_agency__coded?;
...
type IDENTIFICATION_NUMBER_GType record {|
   string Identity_number?;
   string Identity_number_qualifier?;
|};

type IDENTIFICATION_NUMBER_1_GType record {|
   string Identity_number?;
   string Identity_number_qualifier?;
|};

type IDENTIFICATION_NUMBER_2_GType record {|
   string Identity_number?;
   string Identity_number_qualifier?;
|};

type IDENTIFICATION_NUMBER_3_GType record {|
   string Identity_number?;
   string Identity_number_qualifier?;
|};

type IDENTIFICATION_NUMBER_4_GType record {|
   string Identity_number?;
   string Identity_number_qualifier?;
|};
...
type QUANTITY_DIFFERENCE_INFORMATION_GType record {|
   float Quantity_difference?;
   string Quantity_qualifier?;
|};

type REASON_FOR_CHANGE_GType record {|
...
type Segment_Group_23_GType record {|
   Monetary_amount_Type Monetary_amount;
   Currencies_Type Currencies?;
|};

type Segment_Group_24_GType record {|
   Payment_terms_basis_Type Payment_terms_basis;
   Date_time_period_Type[] Date_time_period?;
   Percentage_details_Type Percentage_details?;
   Monetary_amount_Type Monetary_amount?;
...
type PRICE_INFORMATION_GType record {|
...
type PRICE_MULTIPLIER_INFORMATION_GType record {|
   float Price_multiplier?;
   string Price_multiplier_qualifier?;
|};

type REASON_FOR_CHANGE2_GType record {|
   string Change_reason__coded?;
   string Change_reason?;
|};
...
type Segment_Group_25_GType record {|
...
type Segment_Group_26_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_28_GType record {|
   Package_identification_Type Package_identification;
   Reference_Type Reference?;
   Date_time_period_Type[] Date_time_period?;
   Goods_identity_number_Type[] Goods_identity_number?;
...
type Segment_Group_27_GType record {|
   Package_Type Package;
   Measurements_Type[] Measurements?;
   Segment_Group_28_GType[] Segment_Group_28?;
|};

type Segment_Group_29_GType record {|
   Place_location_identification_Type Place_location_identification;
   Quantity_Type Quantity?;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_30_GType record {|
   Duty_tax_fee_details_Type Duty_tax_fee_details;
   Monetary_amount_Type Monetary_amount?;
   Place_location_identification_Type[] Place_location_identification?;
|};

type Segment_Group_32_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_33_GType record {|
   Document_message_details_Type Document_message_details;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_34_GType record {|
   Contact_information_Type Contact_information;
   Communication_contact_Type[] Communication_contact?;
|};

type Segment_Group_31_GType record {|
   Name_and_address_Type Name_and_address;
   Place_location_identification_Type[] Place_location_identification?;
...
type Segment_Group_36_GType record {|
   Quantity_Type Quantity;
   Range_details_Type Range_details?;
|};

type Segment_Group_37_GType record {|
   Percentage_details_Type Percentage_details;
   Range_details_Type Range_details?;
|};

type Segment_Group_38_GType record {|
   Monetary_amount_Type Monetary_amount;
   Range_details_Type Range_details?;
|};

type Segment_Group_39_GType record {|
   Rate_details_Type Rate_details;
   Range_details_Type Range_details?;
|};

type Segment_Group_40_GType record {|
   Duty_tax_fee_details_Type Duty_tax_fee_details;
   Monetary_amount_Type Monetary_amount?;
|};

type Segment_Group_35_GType record {|
   Allowance_or_charge_Type Allowance_or_charge;
   Additional_information_Type[] Additional_information?;
...
type Segment_Group_42_GType record {|
   Place_location_identification_Type Place_location_identification;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_41_GType record {|
   Details_of_transport_Type Details_of_transport;
   Segment_Group_42_GType[] Segment_Group_42?;
|};

type Segment_Group_43_GType record {|
   Terms_of_delivery_Type Terms_of_delivery;
   Place_location_identification_Type[] Place_location_identification?;
|};

type Segment_Group_44_GType record {|
   Requirements_and_conditions_Type Requirements_and_conditions;
   Reference_Type[] Reference?;
   Date_time_period_Type[] Date_time_period?;
   Free_text_Type[] Free_text?;
...
type Segment_Group_22_GType record {|
...
type Segment_Group_46_GType record {|
   Reference_Type Reference;
   Date_time_period_Type[] Date_time_period?;
|};

type Segment_Group_45_GType record {|
   Monetary_amount_Type Monetary_amount;
   Segment_Group_46_GType Segment_Group_46?;
|};

type Segment_Group_47_GType record {|
   Duty_tax_fee_details_Type Duty_tax_fee_details;
   Monetary_amount_Type[] Monetary_amount?;
|};

type Segment_Group_48_GType record {|
   Allowance_or_charge_Type Allowance_or_charge;
   Additional_information_Type Additional_information?;
   Monetary_amount_Type[] Monetary_amount?;
|};
